...
export class LugaresController {
  ...
  @Post()
  create(@Body() criarLugarRequest: CriarLugarRequest, @Param('eventoId') eventoId: string) {
  ...
  @Patch(':lugarId')
  update(@Param('id') lugarId: string,@Param('eventoId') eventoId: string , @Body() atualizarLugarRequest: AtualizarLugarRequest) {
