...
export class EventsController {
  ...
  @UseGuards(AuthGuard)
  @Post(':id/reservar')
  reserveSpot(@Param('id') eventId: string, @Body() reserveRequest: ReservarLugarRequest) {
    return this.eventsService.reserveSpot({ 
      eventId: eventId,
      spots: reserveRequest.lugares,
      ticket_kind: reserveRequest.tipo_ingresso  === 'inteira' ? 'full' : 'half',
